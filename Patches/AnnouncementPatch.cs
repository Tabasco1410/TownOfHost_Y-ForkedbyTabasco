    ...
    public static void Init()
    {
        ...
        */
        var n1000 = new ModNews
        {
            ...
            Title = "TOH_Y ForkedbyTabasco v1.0.0.1.β",
            SubTitle = "<color=#ee7800><b>☆☆</b>v1.0.0.1βアップデート<b>☆☆</b></color>",            
            Text = "このバージョンはβ版です\n\nこんにちは。\nTown Of Host_Y が更新休止になっている中、がんばってYを動かそうとしております。\n\n<b>【このModについて】</b>\nこのModは「TownOfHost_Y」を復活させようという開発者個人のプロジェクトのため、初回リリース時に新しく役職を追加することは考えていません（新規バニラ役職には対応させようと考えています）。\nそもそもまだ完成していませんので、リリースしたうえで安定してModが使用できると判断できれば新しい役職の提案を募集するかもしれません。\nまあまだまだ完成への道のりは長いですので、お待ちください...\n\n現在、Modを導入してAmong Usを起動し、ロビーにて部屋を作成したり、ゲームのオプションを設定することは可能ですが、オンライン・ローカル問わずゲームを開始することができません。\n（オンラインの場合キックされ、ローカルの場合イントロが出ずスポーンが選択できない不具合が発生します。）\n\nリリースまでまだまだ時間がかかると思いますが、もうしばらくお待ちください。\n\nTabasco",
