...
namespace TownOfHostY
{
    ...
    class SetUpRoleTextPatch
    {
        public static void Postfix(IntroCutscene __instance, ref Il2CppSystem.Collections.IEnumerator __result)
        {
            ...
            _ = new LateTask(() =>
            {
                ...
                {
                    Logger.Exception(ex, "SetUpRoleTextPatch");
                }
    ...
    class BeginCrewmatePatch
    {
        public static void Prefix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            {
                Logger.Warn($"BeginCrewmatePatch.Prefix failed: {ex.Message}", "BeginCrewmatePatch");
            }
        }
        ...
        public static void Postfix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            {
                Logger.Exception(ex, "BeginCrewmatePatch");
            }
        }
        ...
        private static async void StartFadeIntro(IntroCutscene __instance, Color start, Color end)
        {
            ...
            {
                Logger.Exception(ex, "StartFadeIntro");
            }
        }
    }
    ...
    class BeginImpostorPatch
    {
        public static bool Prefix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> yourTeam)
        {
            try
            {
                ...
                {
                    // シェリフ等の場合はキャンセルして BeginCrewmate に繋ぐ
                ...
                // Reuse BeginCrewmatePatch's prefix logic for consistency
                BeginCrewmatePatch.Prefix(__instance, ref yourTeam);
                return true;
            }
            catch (Exception ex)
            {
                Logger.Warn($"BeginImpostorPatch.Prefix failed: {ex.Message}", "BeginImpostorPatch");
                return true;
            }
        }
        ...
        public static void Postfix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> yourTeam)
        {
            ...
            {
                Logger.Exception(ex, "BeginImpostorPatch");
            }
        }
    }
